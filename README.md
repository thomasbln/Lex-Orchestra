...
[![Release: v1.2.0](https://img.shields.io/badge/Release-v1.2.0-blue)](https://github.com/thomasbln/Lex-Orchestra/releases)
...
![Install output: four services reachable](docs/assets/install-banner.png)

*After `make seed-validate`: the stack reports which services are up and where to reach them.*

**What to expect:** the first scan on CPU-only hardware takes a few minutes. On a
12-core mini PC (no GPU) it measured 4 min 02 s end-to-end, including local LLM
...
| BSI IT-Grundschutz | 22 controls (titles + mappings, full requirement texts are license-gated, so bring your own Kompendium copy) | BSI |
...
Release: v1.2.0 · License: AGPL-3.0 · [Changelog](CHANGELOG.md) · Partner access: [open an issue](https://github.com/thomasbln/Lex-Orchestra/issues)
